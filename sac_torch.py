...
class Agent(): # tau=0.001
    ...
    def __init__(self, alpha, beta, n_actions, input_dims, tau = 0.001,
        ...
        self.gamma = 0.99#0.8 # 0.5 to 0.8###if it is near 1, it'd be very dependent to the past; therefore, not very adaptable to changes #0.8 ####CHANGE TO 0.8 # 0.99 #0.8 in the TNSM22 paper # was 0.7 in orig code
