...
class Agent():
    def __init__(self, alpha, beta, n_actions, input_dims, tau = 0.9,
    ...
    def replay(self):
        ...
        # self.AL=np.sum(actor_loss)
        # self.CL=np.sum(critic_loss)
