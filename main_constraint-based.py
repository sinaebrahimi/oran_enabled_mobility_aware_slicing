    ...
    def _(self):
        ...
        for e in range(E):
            ...
            for t in range(T-1):
                ...
                self.logarithmic_reward[e, t] = self.log_geometric_mean[e, t] - self.regularization_term[e, t]


                # self.reward += np.sum(self.mat_rate) ############# CHANGED the reward to sum rate
